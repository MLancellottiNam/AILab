...
const I18N = {
  en: {
    ...
    'token.lead': 'This is the API round-trip that would happen against your signature provider.',
  ...
  es: {
    ...
    'token.lead': 'Este es el ida y vuelta con la API que ocurriría contra tu proveedor de firma.',
